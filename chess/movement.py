...
class Movement:
    ...
    def diagonals(self, left_up=True, left_down=True, right_up=True, right_down=True) -> Dict[str, List[Node]]:
    ...
    def cross(self) -> Dict[str, List[Node]]:
    ...
    def lshape(self) -> Dict[str, List[Node]]:
